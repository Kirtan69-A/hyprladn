-- This is an example Hyprland Lua config file. Refer to the wiki for more information.
...
local launcler = "rofi -show drun -show-icons"
...
col = {
    active_border = {
        colors = {
            "rgba(6890a8bb)",  -- sky blue
            "rgba(c8d8e044)",  -- cloud highlight, fades out
        },
        angle = 45
    },
    inactive_border = "rgba(1e3a5055)",
},
...
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(launcler))
hl.bind(secondMod .. " + N", hl.dsp.exec_cmd(runner))
...
-- Region select
hl.bind("SUPER+Print",     hl.dsp.exec_cmd("hyprshot -m region -o ~/Pictures/Screenshots/"), {})
-- Active window
hl.bind("SUPER+SHIFT+Print", hl.dsp.exec_cmd("hyprshot -m window -o ~/Pictures/Screenshots/"), {})
